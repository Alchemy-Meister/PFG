...
Basado en un servidor HTTP Apache\cite{HTTPApache} e implementado en Python\cite{Python}, MOAI incluye todas las funciones básicas como proveedor de datos del protocolo OAI-PMH, indispensables para este proyecto. Por otra parte, permite tanto la extracción la información de documentos XML\cite{XML} como recolectarla de diversos servidores de información tales como Fedora Commons\cite{Fedora}, EPrints\cite{EPrints} o DSpace\cite{DSpace} y almacenar la información cosechada en una base de datos SQLite\cite{SQLite} por defecto.
