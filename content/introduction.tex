...
El presente informe describe el proyecto de desarrollo Gestión de repositorios semánticos compatible con el estándar \acrfull{oaipmh}, un aplicativo que pretende extender a \acrfull{labman}, el \acrfull{dms} usado por grupos de investigación como Internet, Telecom, Mobility y TransLaw de DeustoTech, detallando tanto los objetivos que se pretenden alcanzar con el proyecto, como las fases, actividades y recursos necesarios para llevarlo a cabo.
