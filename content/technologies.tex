...
\begin{itemize}
	...
	\item SQLAlchemy incluye dialectos como SQLite, PostgreSQL, MySQL, Oracle, MS-SQL, Firebird, Sybase y muchas otras por medio de extensiones, por lo que muchas de las clases generadas con esta herramienta pueden ser reutilizadas en caso de migración a una de estas \acrshort{bd}.
