...
Bootstrap-select\cite{BootstrapSelect} es una extensión que añade el estilo característico de Bootstrap las etiquetas \acrshort{html} \textit{select}, sobrescribiendo el estilo dependiente del sistema operativo que disponen por defecto. 
...
\begin{itemize}
	...
	\item El soporte, Bootstrap a acumulado tras de sí una gran comunidad que está dispuesta a solucionar cualquier problema que pueda surgir durante el desarrollo de interfaces gráficas.
	...
	\item Mayormente se ha usado está tecnología dado que \acrshort{labman} estaba desarrollado en esta y era requisito indispensable mantener el \textit{look and feel} de la aplicación en armonía.
\end{itemize}
